    ...
    if train_mode == True:
        ...
        for epoch in range(50):
            ...
            for idx, (data_pair, labels) in enumerate(train_loader):
                ...
                _, x2_recon, x3_recon = autoencoder(audio_feature, depth_feature, radar_feature)
                ...
                optimizer_4.step()
            print("Loss: ", loss_2.item(), loss_3.item())
    ...
    if train_mode == True:
        ...
        for epoch in range(200):
            ...
            for idx, (data_pair, label) in enumerate(train_loader):
                ...
                h_sum = h_sum.view(opt.batch_size, 2, -1)
