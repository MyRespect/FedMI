...
def set_loader(opt): # data is the dataset
    ...
    train_sample_index = random.sample(range(0, dataset_len), int(dataset_len*0.75))
    test_sample_index = list(set(range(0, dataset_len)).difference(set(train_sample_index)))

    # print(len(train_sample_index), len(test_sample_index))
...
if __name__ == "__main__":
    ...
    # len(train_loader) is the num of batches after sampler;
    # len(train_loader.dataset) is the num of samples before sampler.
